-- Cleaned transaction grain (staging). Ephemeral: inlined into the models that
-- build on it (silver_transactions, silver_transfers) so there is no cycle
-- between them and no extra object in the warehouse.
--
...
--   * merchant_name — deterministic cleanup of the raw descriptor.
--
